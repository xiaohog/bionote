...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lingui_react__WEBPACK_IMPORTED_MODULE_2__, _components_Layout__WEBPACK_IMPORTED_MODULE_3__, _i18n__WEBPACK_IMPORTED_MODULE_4__]);
([_lingui_react__WEBPACK_IMPORTED_MODULE_2__, _components_Layout__WEBPACK_IMPORTED_MODULE_3__, _i18n__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async (ctx)=>{
    const translation = await (0,_i18n__WEBPACK_IMPORTED_MODULE_4__/* .loadCatalog */ .R)(ctx.locale);
    return {
        props: {
            translation
        }
...
function Home() {
    const cardClassName = "w-40 h-40 mr-10 bg-bio-white text-xl text-black font-black font-serif rounded-lg flex items-center justify-center   hover:bg-bio-yellow hover:shadow-lg hover:shadow-bio-white hover:text-bio-white  duration-300";
...
var __webpack_exports__ = __webpack_require__.X(0, [940,815,664,212,763], () => (__webpack_exec__(1420)));
